...
contract MoCState_v017 is MoCLibConnection, MoCBase, MoCEMACalculator {
  ...
  function initialize(
    ...
    initializeContracts();
    initializeValues(_governor, _btcPriceProvider,_liq, _utpdu, _maxDiscRate, _dayBlockSpan);
...
/**
  ...
  * @return BPro discount rate [using DISCOUNT_PRECISION].
  ...
  function initialize_v017(uint256 _maxMintBPro) public {
