...
import "./MoCInrate_v017.sol";
import "./base/MoCBase.sol";
import "./MoC.sol";
import "./MoCExchange.sol";
import "./MoCState_v017.sol";

contract MoCExchange_v017 is MoCExchangeEvents, MoCBase, MoCLibConnection  {
  ...
  MoCInrate_v017 internal mocInrate;
  MoC internal moc;
  ...
  */
  function mintBPro(address account, uint256 btcAmount) public onlyWhitelisted(msg.sender) returns(uint256, uint256) {
    ...
    if (mocState.state() == MoCState_v017.States.BProDiscount)
    {
  ...
  **/
  ...
  function initializeContracts() internal {
    ...
    mocInrate = MoCInrate_v017(connector.mocInrate());
  }
