...
### <span id="MoC-mintBPro-uint256-"></span> 
...
### <span id="MoC-isBucketLiquidationReached-bytes32-"></span> 
...
- [`initialize(address connectorAddress, address _governor, uint256 _blockSpan)`][MoCSettlement-initialize-address-address-uint256-]
...
<font size="3">Returns the total amount of Docs in the redeem queue for _who


### <span id="MoCSettlement-addRedeemRequest-uint256-address-payable-"></span>
 `addRedeemRequest(uint256 amount, address payable redeemer)` (public)



<font size="3">Push a new redeem request to the queue for the sender or updates the amount if the user has a redeem request


### <span id="MoCSettlement-clear--"></span>
 `clear()` (public)



<font size="3">Empty the queue

### <span id="MoCSettlement-alterRedeemRequestAmount-bool-uint256-address-"></span> 
`alterRedeemRequestAmount(bool isAddition, uint256 delta, address redeemer)` (public)
...
### <span id="MoCSettlement-runSettlement-uint256-"></span>
 `runSettlement(uint256 steps) → uint256` (public)



<font size="3">Runs settlement process in steps

### <span id="MoCSettlement-initialize-address-address-uint256-"></span>
 `initialize(address connectorAddress, address _governor, uint256 _blockSpan)` (public)

## <span id="BProToken"></span> `BProToken`

It is [OwnerBurnableToken] and [Pausable](https://github.com/OpenZeppelin/openzeppelin-contracts-ethereum-package).


- [`fallback()`][BProToken-fallback--]


### <span id="BProToken-fallback--"></span>
 `fallback()` (external)
...
## <span id="DocToken"></span> `DocToken`
...
## <span id="OwnerBurnableToken"></span> `OwnerBurnableToken`
...
### <span id="OwnerBurnableToken-burn-address-uint256-"></span>
 `burn(address who, uint256 value)` (public)



<font size="3">Burns a specific amount of tokens for the address.



## <span id="MoCBucketContainer"></span> `MoCBucketContainer`

It is [Governed](https://github.com/money-on-chain/Areopagus-Governance)


- [`getBucketNBTC(bytes32 bucket)`][MoCBucketContainer-getBucketNBTC-bytes32-]
- [`getBucketNBPro(bytes32 bucket)`][MoCBucketContainer-getBucketNBPro-bytes32-]
- [`getBucketNDoc(bytes32 bucket)`][MoCBucketContainer-getBucketNDoc-bytes32-]
- [`getBucketCobj(bytes32 bucket)`][MoCBucketContainer-getBucketCobj-bytes32-]
- [`getInrateBag(bytes32 bucket)`][MoCBucketContainer-getInrateBag-bytes32-]
- [`setBucketCobj(bytes32 _bucket, uint256 _cobj)`][MoCBucketContainer-setBucketCobj-bytes32-uint256-]
- [`isBucketBase(bytes32 bucket)`][MoCBucketContainer-isBucketBase-bytes32-]
- [`isBucketEmpty(bytes32 bucket)`][MoCBucketContainer-isBucketEmpty-bytes32-]
- [`getActiveAddresses(bytes32 bucket)`][MoCBucketContainer-getActiveAddresses-bytes32-]
- [`getActiveAddressesCount(bytes32 bucket)`][MoCBucketContainer-getActiveAddressesCount-bytes32-]
- [`addValuesToBucket(bytes32 bucketName, uint256 btc, uint256 doc, uint256 bprox)`][MoCBucketContainer-addValuesToBucket-bytes32-uint256-uint256-uint256-]
- [`substractValuesFromBucket(bytes32 bucketName, uint256 btc, uint256 doc, uint256 bprox)`][MoCBucketContainer-substractValuesFromBucket-bytes32-uint256-uint256-uint256-]
- [`deliverInrate(bytes32 bucketName, uint256 amount)`][MoCBucketContainer-deliverInrate-bytes32-uint256-]
- [`recoverInrate(bytes32 bucketName, uint256 amount)`][MoCBucketContainer-recoverInrate-bytes32-uint256-]
- [`payInrate(bytes32 bucketName, uint256 btcAmount)`][MoCBucketContainer-payInrate-bytes32-uint256-]
- [`moveBtcAndDocs(bytes32 from, bytes32 to, uint256 btc, uint256 docs)`][MoCBucketContainer-moveBtcAndDocs-bytes32-bytes32-uint256-uint256-]
- [`liquidateBucket(bytes32 toLiquidate, bytes32 destination)`][MoCBucketContainer-liquidateBucket-bytes32-bytes32-]
- [`emptyBucket(bytes32 origin, bytes32 destination)`][MoCBucketContainer-emptyBucket-bytes32-bytes32-]
- [`isAvailableBucket(bytes32 bucket)`][MoCBucketContainer-isAvailableBucket-bytes32-]
- [`clearBucketBalances(bytes32 bucketName)`][MoCBucketContainer-clearBucketBalances-bytes32-]]
- [`BucketMovement(bytes32 from, bytes32 to, uint256 reserves, uint256 stableTokens)`][MoCBucketContainer-BucketMovement-bytes32-bytes32-uint256-uint256-]
- [`BucketCreation(bytes32 name, uint256 cobj)`][MoCBucketContainer-BucketCreation-bytes32-uint256-]
- [`BucketStateUpdate(bytes32 name, uint256 nReserve, uint256 nStable, uint256 nRiskProx, uint256 inrateBag)`][MoCBucketContainer-BucketStateUpdate-bytes32-uint256-uint256-uint256-uint256-]
...
### <span id="MoCBucketContainer-getBucketNBTC-bytes32-"></span>
 `getBucketNBTC(bytes32 bucket) → uint256` (public)
### <span id="MoCBucketContainer-getBucketNBPro-bytes32-"></span> 
`getBucketNBPro(bytes32 bucket) → uint256` (public)
...
### <span id="MoCBucketContainer-getBucketNDoc-bytes32-"></span> 
`getBucketNDoc(bytes32 bucket) → uint256` (public)
...
### <span id="MoCBucketContainer-getBucketCobj-bytes32-"></span> 
`getBucketCobj(bytes32 bucket) → uint256` (public)
...
### <span id="MoCBucketContainer-getInrateBag-bytes32-"></span> 
`getInrateBag(bytes32 bucket) → uint256` (public)
...
### <span id="MoCBucketContainer-setBucketCobj-bytes32-uint256-"></span>
 `setBucketCobj(bytes32 _bucket, uint256 _cobj)` (public)



<font size="3">Sets the objective coverage (cobj) on an specficied bucket.


### <span id="MoCBucketContainer-isBucketBase-bytes32-"></span> 
`isBucketBase(bytes32 bucket) → bool` (public)



<font size="3">Returns true if the bucket is a base bucket


### <span id="MoCBucketContainer-isBucketEmpty-bytes32-"></span>
 `isBucketEmpty(bytes32 bucket) → bool` (public)



<font size="3">Returns true if the bucket have docs in it


### <span id="MoCBucketContainer-getActiveAddresses-bytes32-"></span> 
`getActiveAddresses(bytes32 bucket) → address payable[]` (public)



<font size="3">Returns all the address that currently have bprox position for this bucket


### <span id="MoCBucketContainer-getActiveAddressesCount-bytes32-"></span>
 `getActiveAddressesCount(bytes32 bucket) → uint256 count` (public)
...
### <span id="MoCBucketContainer-addValuesToBucket-bytes32-uint256-uint256-uint256-"></span>
 `addValuesToBucket(bytes32 bucketName, uint256 btc, uint256 doc, uint256 bprox)` (public)



<font size="3">Add values to all variables of the bucket


### <span id="MoCBucketContainer-substractValuesFromBucket-bytes32-uint256-uint256-uint256-"></span>
 `substractValuesFromBucket(bytes32 bucketName, uint256 btc, uint256 doc, uint256 bprox)` (public)



<font size="3">Substract values to all variables of the bucket


### <span id="MoCBucketContainer-deliverInrate-bytes32-uint256-"></span>
 `deliverInrate(bytes32 bucketName, uint256 amount)` (public)



<font size="3">Moves BTC from inrateBag to main BTC bucket bag


### <span id="MoCBucketContainer-recoverInrate-bytes32-uint256-"></span>
 `recoverInrate(bytes32 bucketName, uint256 amount) → uint256` (public)



<font size="3">Removes Interests rate from Inrate bag


### <span id="MoCBucketContainer-payInrate-bytes32-uint256-"></span>
 `payInrate(bytes32 bucketName, uint256 btcAmount)` (public)



<font size="3">Moves BTC from origin bucket to destination bucket inrateBag


### <span id="MoCBucketContainer-moveBtcAndDocs-bytes32-bytes32-uint256-uint256-"></span>
 `moveBtcAndDocs(bytes32 from, bytes32 to, uint256 btc, uint256 docs)` (public)



<font size="3">Move Btcs and Docs from one bucket to another


### <span id="MoCBucketContainer-liquidateBucket-bytes32-bytes32-"></span>
 `liquidateBucket(bytes32 toLiquidate, bytes32 destination)` (public)



<font size="3">Clears completely the origin bucket, removing all Docs, RBTCs and bproxs


### <span id="MoCBucketContainer-emptyBucket-bytes32-bytes32-"></span>
 `emptyBucket(bytes32 origin, bytes32 destination)` (public)



<font size="3">Clears Docs and BTC from bucket origin and sends them to destination bucket


### <span id="MoCBucketContainer-isAvailableBucket-bytes32-"></span>
 `isAvailableBucket(bytes32 bucket) → bool` (public)



<font size="3">Checks if a bucket exists


### <span id="MoCBucketContainer-clearBucketBalances-bytes32-"></span> 
`clearBucketBalances(bytes32 bucketName)` (public)



<font size="3">Put all bucket BProx balances in zero


### <span id="MoCBucketContainer-BucketMovement-bytes32-bytes32-uint256-uint256-"></span>
 `BucketMovement(bytes32 from, bytes32 to, uint256 reserves, uint256 stableTokens)`





### <span id="MoCBucketContainer-BucketCreation-bytes32-uint256-"></span>
 `BucketCreation(bytes32 name, uint256 cobj)`
...
## <span id="MoCBurnoutEvents"></span> `MoCBurnoutEvents`





- [`BurnoutAddressSet(address account, address burnoutAddress)`][MoCBurnoutEvents-BurnoutAddressSet-address-address-]
- [`BurnoutExecuted(uint256 addressCount)`][MoCBurnoutEvents-BurnoutExecuted-uint256-]
- [`BurnoutAddressProcessed(address account, address burnoutAddress, uint256 btcAmount)`][MoCBurnoutEvents-BurnoutAddressProcessed-address-address-uint256-]

### <span id="MoCBurnoutEvents-BurnoutAddressSet-address-address-"></span> 
`BurnoutAddressSet(address account, address burnoutAddress)`





### <span id="MoCBurnoutEvents-BurnoutExecuted-uint256-"></span> 
`BurnoutExecuted(uint256 addressCount)`





### <span id="MoCBurnoutEvents-BurnoutAddressProcessed-address-address-uint256-"></span>
 `BurnoutAddressProcessed(address account, address burnoutAddress, uint256 btcAmount)`
...
## <span id="MoCBurnout"></span> `MoCBurnout`



Track all Burnout addresses that will be used in liquidation event. When liquidation happens
all Docs of the holders in the queue will be sent to the corresponding burnout address.
It is [MoCBurnoutEvents]


- [`isBurnoutRunning()`][MoCBurnout-isBurnoutRunning--]
- [`burnoutQueueSize()`][MoCBurnout-burnoutQueueSize--]
...
### <span id="MoCBurnout-burnoutQueueSize--"></span> 
`burnoutQueueSize() → uint256` (public)



<font size="3">Return current burnout queue size

### <span id="MoCBurnout-getBurnoutAddress-address-"></span> 
`getBurnoutAddress(address _who) → address` (public)



<font size="3">Returns the burnout address for _who address


### <span id="MoCBurnout-pushBurnoutAddress-address-address-payable-"></span>
 `pushBurnoutAddress(address _who, address payable _burnout)` (public)



<font size="3">Push a new burnout address to the queue for _who


### <span id="MoCBurnout-executeBurnout-uint256-"></span> 
`executeBurnout(uint256 steps)` (public)



<font size="3">Iterate over the burnout address book and redeem docs*

### <span id="MoCBurnout-initialize-address-"></span> 
`initialize(address connectorAddress)` (public)

## <span id="MoCConverter"></span> `MoCConverter`

It is  [MoCLibConnection]



- [`bproToBtc(uint256 amount)`][MoCConverter-bproToBtc-uint256-]
- [`btcToBPro(uint256 btcAmount)`][MoCConverter-btcToBPro-uint256-]
- [`bproDiscToBtc(uint256 amount)`][MoCConverter-bproDiscToBtc-uint256-]
- [`btcToBProDisc(uint256 btcAmount)`][MoCConverter-btcToBProDisc-uint256-]
- [`docsToBtc(uint256 docAmount)`][MoCConverter-docsToBtc-uint256-]
- [`docsToBtcWithPrice(uint256 docAmount, uint256 btcPrice)`][MoCConverter-docsToBtcWithPrice-uint256-uint256-]
- [`btcToDoc(uint256 btcAmount)`][MoCConverter-btcToDoc-uint256-]
- [`bproxToBtc(uint256 bproxAmount, bytes32 bucket)`][MoCConverter-bproxToBtc-uint256-bytes32-]
- [`btcToBProx(uint256 btcAmount, bytes32 bucket)`][MoCConverter-btcToBProx-uint256-bytes32-]
- [`btcToBProWithPrice(uint256 btcAmount, uint256 price)`][MoCConverter-btcToBProWithPrice-uint256-uint256-]
- [`bproToBtcWithPrice(uint256 bproAmount, uint256 bproPrice)`][MoCConverter-bproToBtcWithPrice-uint256-uint256-]
- [`initialize(address connectorAddress)`][MoCConverter-initialize-address-]
...
### <span id="MoCConverter-bproToBtc-uint256-"></span> 
`bproToBtc(uint256 amount) → uint256` (public)



<font size="3">BTC equivalent for the amount of bpros given


### <span id="MoCConverter-btcToBPro-uint256-"></span> 
`btcToBPro(uint256 btcAmount) → uint256` (public)





### <span id="MoCConverter-bproDiscToBtc-uint256-"></span>
 `bproDiscToBtc(uint256 amount) → uint256` (public)



<font size="3">BTC equivalent for the amount of bpro given applying the spotDiscountRate


### <span id="MoCConverter-btcToBProDisc-uint256-"></span> 
`btcToBProDisc(uint256 btcAmount) → uint256` (public)





### <span id="MoCConverter-docsToBtc-uint256-"></span> 
`docsToBtc(uint256 docAmount) → uint256` (public)





### <span id="MoCConverter-docsToBtcWithPrice-uint256-uint256-">
</span> `docsToBtcWithPrice(uint256 docAmount, uint256 btcPrice) → uint256` (public)





### <span id="MoCConverter-btcToDoc-uint256-"></span>
 `btcToDoc(uint256 btcAmount) → uint256` (public)





### <span id="MoCConverter-bproxToBtc-uint256-bytes32-"></span> 
`bproxToBtc(uint256 bproxAmount, bytes32 bucket) → uint256` (public)





### <span id="MoCConverter-btcToBProx-uint256-bytes32-"></span> 
`btcToBProx(uint256 btcAmount, bytes32 bucket) → uint256` (public)





### <span id="MoCConverter-btcToBProWithPrice-uint256-uint256-">
</span> `btcToBProWithPrice(uint256 btcAmount, uint256 price) → uint256` (public)





### <span id="MoCConverter-bproToBtcWithPrice-uint256-uint256-">
</span> `bproToBtcWithPrice(uint256 bproAmount, uint256 bproPrice) → uint256` (public)

### <span id="MoCConverter-initialize-address-"></span> 
`initialize(address connectorAddress)` (public)
...
## <span id="MoCEMACalculator"></span> `MoCEMACalculator`

It is [Governed](https://github.com/money-on-chain/Areopagus-Governance)


- [`getBitcoinMovingAverage()`][MoCEMACalculator-getBitcoinMovingAverage--]
- [`getSmoothingFactor()`][MoCEMACalculator-getSmoothingFactor--]
- [`setSmoothingFactor(uint256 factor)`][MoCEMACalculator-setSmoothingFactor-uint256-]
- [`getGovernorAddress()`][MoCEMACalculator-getGovernorAddress--]
- [`getEmaCalculationBlockSpan()`][MoCEMACalculator-getEmaCalculationBlockSpan--]
- [`setEmaCalculationBlockSpan(uint256 blockSpan)`][MoCEMACalculator-setEmaCalculationBlockSpan-uint256-]
- [`shouldCalculateEma()`][MoCEMACalculator-shouldCalculateEma--]
- [`getLastEmaCalculation()`][MoCEMACalculator-getLastEmaCalculation--]
- [`MovingAverageCalculation(uint256 price, uint256 movingAverage)`][MoCEMACalculator-MovingAverageCalculation-uint256-uint256-]

### <span id="MoCEMACalculator-getBitcoinMovingAverage--"></span>
 `getBitcoinMovingAverage() → uint256` (public)





### <span id="MoCEMACalculator-getSmoothingFactor--"></span>
 `getSmoothingFactor() → uint256` (public)





### <span id="MoCEMACalculator-setSmoothingFactor-uint256-"></span>
 `setSmoothingFactor(uint256 factor)` (public)





### <span id="MoCEMACalculator-getGovernorAddress--"></span> 
`getGovernorAddress() → address` (public)





### <span id="MoCEMACalculator-getEmaCalculationBlockSpan--"></span>
 `getEmaCalculationBlockSpan() → uint256` (public)





### <span id="MoCEMACalculator-setEmaCalculationBlockSpan-uint256-">
</span> `setEmaCalculationBlockSpan(uint256 blockSpan)` (public)





### <span id="MoCEMACalculator-shouldCalculateEma--"></span> 
`shouldCalculateEma() → bool` (public)





### <span id="MoCEMACalculator-getLastEmaCalculation--"></span>
 `getLastEmaCalculation() → uint256` (public)

### <span id="MoCEMACalculator-MovingAverageCalculation-uint256-uint256-"></span>
 `MovingAverageCalculation(uint256 price, uint256 movingAverage)`
...
## <span id="MoCHelperLib"></span> `MoCHelperLib`





- [`inrateAvg(struct MoCHelperLib.MocLibConfig config, uint256 tMax, uint256 power, uint256 tMin, uint256 abRat1, uint256 abRat2)`][MoCHelperLib-inrateAvg-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-uint256-uint256-]
- [`spotInrate(struct MoCHelperLib.MocLibConfig config, uint256 tMax, uint256 power, uint256 tMin, uint256 abRatio)`][MoCHelperLib-spotInrate-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-uint256-]
- [`potential(struct MoCHelperLib.MocLibConfig config, uint256 a, uint256 b, uint256 c, uint256 value)`][MoCHelperLib-potential-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-uint256-]
- [`avgInt(struct MoCHelperLib.MocLibConfig config, uint256 a, uint256 b, uint256 c, uint256 value1, uint256 value2)`][MoCHelperLib-avgInt-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-uint256-uint256-]
- [`integral(struct MoCHelperLib.MocLibConfig config, uint256 a, uint256 b, uint256 c, uint256 value)`][MoCHelperLib-integral-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-uint256-]
- [`abundanceRatio(struct MoCHelperLib.MocLibConfig config, uint256 doc0, uint256 doct)`][MoCHelperLib-abundanceRatio-struct-MoCHelperLib-MocLibConfig-uint256-uint256-]
- [`bproSpotDiscountRate(struct MoCHelperLib.MocLibConfig libConfig, uint256 bproLiqDiscountRate, uint256 liq, uint256 utpdu, uint256 cov)`][MoCHelperLib-bproSpotDiscountRate-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-uint256-]
- [`maxBProWithDiscount(struct MoCHelperLib.MocLibConfig libConfig, uint256 nB, uint256 nDoc, uint256 utpdu, uint256 peg, uint256 btcPrice, uint256 bproUsdPrice, uint256 spotDiscount)`][MoCHelperLib-maxBProWithDiscount-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-uint256-uint256-uint256-uint256-]
- [`lockedBitcoin(struct MoCHelperLib.MocLibConfig libConfig, uint256 btcPrice, uint256 nDoc, uint256 peg)`][MoCHelperLib-lockedBitcoin-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-]
- [`liquidationPrice(struct MoCHelperLib.MocLibConfig libConfig, uint256 rbtcAmount, uint256 nDoc)`][MoCHelperLib-liquidationPrice-struct-MoCHelperLib-MocLibConfig-uint256-uint256-]
- [`bproTecPrice(struct MoCHelperLib.MocLibConfig libConfig, uint256 nB, uint256 lb, uint256 nTP)`][MoCHelperLib-bproTecPrice-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-]
- [`bproxBProPrice(struct MoCHelperLib.MocLibConfig libConfig, uint256 bproxTecPrice, uint256 bproPrice)`][MoCHelperLib-bproxBProPrice-struct-MoCHelperLib-MocLibConfig-uint256-uint256-]
- [`applyDiscountRate(struct MoCHelperLib.MocLibConfig libConfig, uint256 price, uint256 discountRate)`][MoCHelperLib-applyDiscountRate-struct-MoCHelperLib-MocLibConfig-uint256-uint256-]
- [`getInterestCost(struct MoCHelperLib.MocLibConfig libConfig, uint256 value, uint256 interestRate)`][MoCHelperLib-getInterestCost-struct-MoCHelperLib-MocLibConfig-uint256-uint256-]
- [`coverage(struct MoCHelperLib.MocLibConfig libConfig, uint256 nB, uint256 lB)`][MoCHelperLib-coverage-struct-MoCHelperLib-MocLibConfig-uint256-uint256-]
- [`leverageFromCoverage(struct MoCHelperLib.MocLibConfig libConfig, uint256 cov)`][MoCHelperLib-leverageFromCoverage-struct-MoCHelperLib-MocLibConfig-uint256-]
- [`leverage(struct MoCHelperLib.MocLibConfig libConfig, uint256 nB, uint256 lB)`][MoCHelperLib-leverage-struct-MoCHelperLib-MocLibConfig-uint256-uint256-]
- [`docsBtcValue(struct MoCHelperLib.MocLibConfig libConfig, uint256 amount, uint256 peg, uint256 btcPrice)`][MoCHelperLib-docsBtcValue-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-]
- [`bproBtcValue(struct MoCHelperLib.MocLibConfig libConfig, uint256 bproAmount, uint256 bproBtcPrice)`][MoCHelperLib-bproBtcValue-struct-MoCHelperLib-MocLibConfig-uint256-uint256-]
- [`maxBPro(struct MoCHelperLib.MocLibConfig libConfig, uint256 nB, uint256 cobj, uint256 nDoc, uint256 peg, uint256 btcPrice, uint256 bCons, uint256 bproUsdPrice)`][MoCHelperLib-maxBPro-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-uint256-uint256-uint256-uint256-]
- [`totalBProInBtc(struct MoCHelperLib.MocLibConfig libConfig, uint256 amount, uint256 bproPrice)`][MoCHelperLib-totalBProInBtc-struct-MoCHelperLib-MocLibConfig-uint256-uint256-]
- [`maxDocsWithBtc(struct MoCHelperLib.MocLibConfig libConfig, uint256 btcAmount, uint256 btcPrice)`][MoCHelperLib-maxDocsWithBtc-struct-MoCHelperLib-MocLibConfig-uint256-uint256-]
- [`maxBProWithBtc(struct MoCHelperLib.MocLibConfig libConfig, uint256 btcAmount, uint256 bproPrice)`][MoCHelperLib-maxBProWithBtc-struct-MoCHelperLib-MocLibConfig-uint256-uint256-]
- [`bucketTransferAmount(struct MoCHelperLib.MocLibConfig libConfig, uint256 btcAmount, uint256 lev)`][MoCHelperLib-bucketTransferAmount-struct-MoCHelperLib-MocLibConfig-uint256-uint256-]
- [`maxBProxBtcValue(struct MoCHelperLib.MocLibConfig libConfig, uint256 nDoc, uint256 peg, uint256 btcPrice, uint256 lev)`][MoCHelperLib-maxBProxBtcValue-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-uint256-]
### <span id="MoCHelperLib-inrateAvg-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-uint256-uint256-"></span>
 `inrateAvg(struct MoCHelperLib.MocLibConfig config, uint256 tMax, uint256 power, uint256 tMin, uint256 abRat1, uint256 abRat2) → uint256` (public)

<font size="3">Calculates average interest using integral function


<font size="3">T =  Rate = a * (x ** b) + c


### <span id="MoCHelperLib-spotInrate-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-uint256-"></span>
 `spotInrate(struct MoCHelperLib.MocLibConfig config, uint256 tMax, uint256 power, uint256 tMin, uint256 abRatio) → uint256` (public)

<font size="3">Calculates spot interest rate that BProx owners should pay to BPro owners


<font size="3">Rate = tMax * (abRatio ** power) + tMin


### <span id="MoCHelperLib-potential-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-uint256-"></span>
 `potential(struct MoCHelperLib.MocLibConfig config, uint256 a, uint256 b, uint256 c, uint256 value) → uint256` (public)

<font size="3">Calculates potential interests function with given parameters


<font size="3">Rate = a * (x ** b) + c


### <span id="MoCHelperLib-avgInt-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-uint256-uint256-"></span>
 `avgInt(struct MoCHelperLib.MocLibConfig config, uint256 a, uint256 b, uint256 c, uint256 value1, uint256 value2) → uint256` (public)

<font size="3">Calculates average of the integral function
...
### <span id="MoCHelperLib-integral-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-uint256-"></span>
 `integral(struct MoCHelperLib.MocLibConfig config, uint256 a, uint256 b, uint256 c, uint256 value) → uint256` (public)

<font size="3">Calculates integral of the exponential function


<font size="3">T = c * (value) + (a * value ** (b + 1)) / (b + 1))


### <span id="MoCHelperLib-abundanceRatio-struct-MoCHelperLib-MocLibConfig-uint256-uint256-"></span>
 `abundanceRatio(struct MoCHelperLib.MocLibConfig config, uint256 doc0, uint256 doct) → uint256` (public)
...
### <span id="MoCHelperLib-bproSpotDiscountRate-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-uint256-"></span> 
`bproSpotDiscountRate(struct MoCHelperLib.MocLibConfig libConfig, uint256 bproLiqDiscountRate, uint256 liq, uint256 utpdu, uint256 cov) → uint256` (public)

<font size="3">SpotDiscountRate = TPD * (utpdu - cob) / (uptdu -liq)


<font size="3">Returns the ratio to apply to BPro Price in discount situations


### <span id="MoCHelperLib-maxBProWithDiscount-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-uint256-uint256-uint256-uint256-"></span>
 `maxBProWithDiscount(struct MoCHelperLib.MocLibConfig libConfig, uint256 nB, uint256 nDoc, uint256 utpdu, uint256 peg, uint256 btcPrice, uint256 bproUsdPrice, uint256 spotDiscount) → uint256` (public)

<font size="3">MaxBProWithDiscount = (uTPDU * nDOC * PEG - (nBTC * B)) / (TPusd * TPD)


<font size="3">Max amount of BPro to available with discount


### <span id="MoCHelperLib-lockedBitcoin-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-"></span>
 `lockedBitcoin(struct MoCHelperLib.MocLibConfig libConfig, uint256 btcPrice, uint256 nDoc, uint256 peg) → uint256` (public)



<font size="3">Calculates Locked bitcoin


### <span id="MoCHelperLib-liquidationPrice-struct-MoCHelperLib-MocLibConfig-uint256-uint256-"></span>
 `liquidationPrice(struct MoCHelperLib.MocLibConfig libConfig, uint256 rbtcAmount, uint256 nDoc) → uint256` (public)



<font size="3">Calculates price at liquidation event as a relation between the doc total supply and the amount of RBTC available to distribute


### <span id="MoCHelperLib-bproTecPrice-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-"></span>
 `bproTecPrice(struct MoCHelperLib.MocLibConfig libConfig, uint256 nB, uint256 lb, uint256 nTP) → uint256` (public)

<font size="3">TPbtc = (nB-LB) / nTP


<font size="3">Calculates BPro BTC price


### <span id="MoCHelperLib-bproxBProPrice-struct-MoCHelperLib-MocLibConfig-uint256-uint256-"></span>
 `bproxBProPrice(struct MoCHelperLib.MocLibConfig libConfig, uint256 bproxTecPrice, uint256 bproPrice) → uint256` (public)

<font size="3">BProxInBPro = bproxTecPrice / bproPrice


<font size="3">Calculates BPro BTC price.


### <span id="MoCHelperLib-applyDiscountRate-struct-MoCHelperLib-MocLibConfig-uint256-uint256-"></span>
 `applyDiscountRate(struct MoCHelperLib.MocLibConfig libConfig, uint256 price, uint256 discountRate) → uint256` (public)

<font size="3">TPbtc = (price)* (1 - discountRate)


<font size="3">Returns a new value with the discountRate applied.


### <span id="MoCHelperLib-getInterestCost-struct-MoCHelperLib-MocLibConfig-uint256-uint256-"></span> 
`getInterestCost(struct MoCHelperLib.MocLibConfig libConfig, uint256 value, uint256 interestRate) → uint256` (public)

<font size="3">TPbtc = price * interestRate


<font size="3">Returns the amount of interest to pay.


### <span id="MoCHelperLib-coverage-struct-MoCHelperLib-MocLibConfig-uint256-uint256-"></span>
 `coverage(struct MoCHelperLib.MocLibConfig libConfig, uint256 nB, uint256 lB) → uint256` (public)

<font size="3">Coverage = nB / LB


Calculates Coverage


### <span id="MoCHelperLib-leverageFromCoverage-struct-MoCHelperLib-MocLibConfig-uint256-"></span>
 `leverageFromCoverage(struct MoCHelperLib.MocLibConfig libConfig, uint256 cov) → uint256` (public)


<font size="3">Calculates Leverage
<font size="3">Leverage = C / (C - 1)


### <span id="MoCHelperLib-leverage-struct-MoCHelperLib-MocLibConfig-uint256-uint256-"></span>
 `leverage(struct MoCHelperLib.MocLibConfig libConfig, uint256 nB, uint256 lB) → uint256` (public)

<font size="3">Calculates Leverage
<font size="3">Leverage = nB / (nB - lB)



### <span id="MoCHelperLib-docsBtcValue-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-"></span>
 `docsBtcValue(struct MoCHelperLib.MocLibConfig libConfig, uint256 amount, uint256 peg, uint256 btcPrice) → uint256` (public)



<font size="3">Price in BTC of the amount of Docs.


### <span id="MoCHelperLib-bproBtcValue-struct-MoCHelperLib-MocLibConfig-uint256-uint256-"></span>
`bproBtcValue(struct MoCHelperLib.MocLibConfig libConfig, uint256 bproAmount, uint256 bproBtcPrice) → uint256` (public)



<font size="3">Price in RBTC of the amount of BPros.


### <span id="MoCHelperLib-maxBPro-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-uint256-uint256-uint256-uint256-"></span> 
`maxBPro(struct MoCHelperLib.MocLibConfig libConfig, uint256 nB, uint256 cobj, uint256 nDoc, uint256 peg, uint256 btcPrice, uint256 bCons, uint256 bproUsdPrice) → uint256` (public)

<font size="3">MaxBPro = ((nB*B)-(Cobj*nDoc*PEG))/TPusd


<font size="3">Max amount of BPro to redeem.


### <span id="MoCHelperLib-totalBProInBtc-struct-MoCHelperLib-MocLibConfig-uint256-uint256-"></span>
 `totalBProInBtc(struct MoCHelperLib.MocLibConfig libConfig, uint256 amount, uint256 bproPrice) → uint256` (public)



<font size="3">Calculates the total BTC price of the amount of BPros.


### <span id="MoCHelperLib-maxDocsWithBtc-struct-MoCHelperLib-MocLibConfig-uint256-uint256-"></span>
 `maxDocsWithBtc(struct MoCHelperLib.MocLibConfig libConfig, uint256 btcAmount, uint256 btcPrice) → uint256` (public)



<font size="3">Calculates the equivalent in Docs of the btcAmount.


### <span id="MoCHelperLib-maxBProWithBtc-struct-MoCHelperLib-MocLibConfig-uint256-uint256-"></span>
 `maxBProWithBtc(struct MoCHelperLib.MocLibConfig libConfig, uint256 btcAmount, uint256 bproPrice) → uint256` (public)



<font size="3">Calculates the equivalent in BPro of the btcAmount


### <span id="MoCHelperLib-bucketTransferAmount-struct-MoCHelperLib-MocLibConfig-uint256-uint256-"></span> 
`bucketTransferAmount(struct MoCHelperLib.MocLibConfig libConfig, uint256 btcAmount, uint256 lev) → uint256` (public)

<font size="3">Calculates the Btc amount to move from C0 bucket to an L bucket when a BProx minting occurs.
<font size="3">toMove = btcAmount * (lev - 1)


### <span id="MoCHelperLib-maxBProxBtcValue-struct-MoCHelperLib-MocLibConfig-uint256-uint256-uint256-uint256-"></span> 
`maxBProxBtcValue(struct MoCHelperLib.MocLibConfig libConfig, uint256 nDoc, uint256 peg, uint256 btcPrice, uint256 lev) → uint256` (public)

<font size="3">Maxbprox = nDOC/ (PEG*B*(lev-1))


<font size="3">Max amount of BTC allowed to be used to mint bprox

## <span id="MoCInrateEvents"></span> `MoCInrateEvents`





- [`InrateDailyPay(uint256 amount, uint256 daysToSettlement, uint256 nReserveBucketC0)`][MoCInrateEvents-InrateDailyPay-uint256-uint256-uint256-]
- [`RiskProHoldersInterestPay(uint256 amount, uint256 nReserveBucketC0BeforePay)`][MoCInrateEvents-RiskProHoldersInterestPay-uint256-uint256-]

### <span id="MoCInrateEvents-InrateDailyPay-uint256-uint256-uint256-"></span>
 `InrateDailyPay(uint256 amount, uint256 daysToSettlement, uint256 nReserveBucketC0)`





### <span id="MoCInrateEvents-RiskProHoldersInterestPay-uint256-uint256-"></span>
 `RiskProHoldersInterestPay(uint256 amount, uint256 nReserveBucketC0BeforePay)`
...
## <span id="MoCInrate"></span> `MoCInrate`

It is [Governed](https://github.com/money-on-chain/Areopagus-Governance), [MoCInrateEvents]


- [`setDoCTmin(uint256 _docTmin)`][MoCInrate-setDoCTmin-uint256-]
- [`setDoCTmax(uint256 _docTmax)`][MoCInrate-setDoCTmax-uint256-]
- [`setDoCPower(uint256 _docPower)`][MoCInrate-setDoCPower-uint256-]
- [`getDoCTmin()`][MoCInrate-getDoCTmin--]
- [`getDoCTmax()`][MoCInrate-getDoCTmax--]
- [`getDoCPower()`][MoCInrate-getDoCPower--]
- [`docInrateAvg(uint256 docRedeem)`][MoCInrate-docInrateAvg-uint256-]
- [`getBtcxTmin()`][MoCInrate-getBtcxTmin--]
- [`getBtcxTmax()`][MoCInrate-getBtcxTmax--]
- [`getBtcxPower()`][MoCInrate-getBtcxPower--]
- [`getBitProInterestBlockSpan()`][MoCInrate-getBitProInterestBlockSpan--]
- [`setBtcxTmin(uint256 _btxcTmin)`][MoCInrate-setBtcxTmin-uint256-]
- [`setBtcxTmax(uint256 _btxcTax)`][MoCInrate-setBtcxTmax-uint256-]
- [`setBtcxPower(uint256 _btxcPower)`][MoCInrate-setBtcxPower-uint256-]
- [`getBitProRate()`][MoCInrate-getBitProRate--]
- [`getCommissionRate()`][MoCInrate-getCommissionRate--]
- [`setBitProRate(uint256 newBitProRate)`][MoCInrate-setBitProRate-uint256-]
- [`setBitProInterestBlockSpan(uint256 newBitProBlockSpan)`][MoCInrate-setBitProInterestBlockSpan-uint256-]
...
- [`calcMintInterestValues(bytes32 bucket, uint256 rbtcAmount)`][MoCInrate-calcMintInterestValues-bytes32-uint256-]
- [`calcDocRedInterestValues(uint256 docAmount, uint256 rbtcAmount)`][MoCInrate-calcDocRedInterestValues-uint256-uint256-]
- [`calcFinalRedeemInterestValue(bytes32 bucket, uint256 rbtcToRedeem)`][MoCInrate-calcFinalRedeemInterestValue-bytes32-uint256-]
- [`calcCommissionValue(uint256 rbtcAmount)`][MoCInrate-calcCommissionValue-uint256-]
- [`calcRedeemInterestValue(bytes32 bucket, uint256 rbtcToRedeem)`][MoCInrate-calcRedeemInterestValue-bytes32-uint256-]
- [`dailyInratePayment()`][MoCInrate-dailyInratePayment--]
- [`isDailyEnabled()`][MoCInrate-isDailyEnabled--]
- [`isBitProInterestEnabled()`][MoCInrate-isBitProInterestEnabled--]
- [`calculateBitProHoldersInterest()`][MoCInrate-calculateBitProHoldersInterest--]
...
### <span id="MoCInrate-setDoCTmin-uint256-"></span> 
`setDoCTmin(uint256 _docTmin)` (public)





### <span id="MoCInrate-setDoCTmax-uint256-"></span>
 `setDoCTmax(uint256 _docTmax)` (public)





### <span id="MoCInrate-setDoCPower-uint256-"></span>
 `setDoCPower(uint256 _docPower)` (public)





### <span id="MoCInrate-getDoCTmin--"></span>
 `getDoCTmin() → uint256` (public)





### <span id="MoCInrate-getDoCTmax--"></span>
 `getDoCTmax() → uint256` (public)





### <span id="MoCInrate-getDoCPower--"></span>
 `getDoCPower() → uint256` (public)





### <span id="MoCInrate-docInrateAvg-uint256-"></span>
 `docInrateAvg(uint256 docRedeem) → uint256` (public)



<font size="3">Calculates an average interest rate between after and before free doc Redemption



### <span id="MoCInrate-getBtcxTmin--"></span> 
`getBtcxTmin() → uint256` (public)



<font size="3">Gets tMin param of BTCX tokens


### <span id="MoCInrate-getBtcxTmax--"></span>
 `getBtcxTmax() → uint256` (public)



<font size="3">Gets tMax param of BTCX tokens


### <span id="MoCInrate-getBtcxPower--"></span>
 `getBtcxPower() → uint256` (public)



<font size="3">Gets power param of BTCX tokens


### <span id="MoCInrate-getBitProInterestBlockSpan--"></span>
 `getBitProInterestBlockSpan() → uint256` (public)



<font size="3">Gets the blockspan of BPRO that represents the frecuency of BitPro holders intereset payment


### <span id="MoCInrate-setBtcxTmin-uint256-"></span> 
`setBtcxTmin(uint256 _btxcTmin)` (public)



<font size="3">Sets tMin param of BTCX tokens


### <span id="MoCInrate-setBtcxTmax-uint256-"></span>
 `setBtcxTmax(uint256 _btxcTax)` (public)



<font size="3">Sets tMax param of BTCX tokens


### <span id="MoCInrate-setBtcxPower-uint256-"></span> 
`setBtcxPower(uint256 _btxcPower)` (public)



<font size="3">Sets power param of BTCX tokens


### <span id="MoCInrate-getBitProRate--"></span>
 `getBitProRate() → uint256` (public)



<font size="3">Gets the rate for BitPro Holders


### <span id="MoCInrate-getCommissionRate--"></span> 
`getCommissionRate() → uint256` (public)





### <span id="MoCInrate-setBitProRate-uint256-"></span>
 `setBitProRate(uint256 newBitProRate)` (public)



<font size="3">Sets BitPro Holders rate


### <span id="MoCInrate-setBitProInterestBlockSpan-uint256-"></span> 
`setBitProInterestBlockSpan(uint256 newBitProBlockSpan)` (public)



<font size="3">Sets the blockspan BitPro Intereset rate payment is enable to be executed


### <span id="MoCInrate-getBitProInterestAddress--"></span> 
`getBitProInterestAddress() → address payable` (public)



<font size="3">Gets the target address to transfer BitPro Holders rate


### <span id="MoCInrate-setBitProInterestAddress-address-payable-"></span>
 `setBitProInterestAddress(address payable newBitProInterestAddress)` (public)



<font size="3">Sets the target address to transfer BitPro Holders rate


### <span id="MoCInrate-setCommissionsAddress-address-payable-"></span>
 `setCommissionsAddress(address payable newCommissionsAddress)` (public)
...
### <span id="MoCInrate-spotInrate--"></span>
 `spotInrate() → uint256` (public)



<font size="3">Calculates interest rate for BProx Minting, redeem and Free Doc Redeem


### <span id="MoCInrate-btcxInrateAvg-bytes32-uint256-bool-"></span> 
`btcxInrateAvg(bytes32 bucket, uint256 btcAmount, bool onMinting) → uint256` (public)



<font size="3">Calculates an average interest rate between after and before mint/redeem


### <span id="MoCInrate-dailyInrate--"></span>
 `dailyInrate() → uint256` (public)



<font size="3">Returns the amount of BTC to pay in concept of interest to bucket C0

### <span id="MoCInrate-calcMintInterestValues-bytes32-uint256-"></span>
 `calcMintInterestValues(bytes32 bucket, uint256 rbtcAmount) → uint256` (public)



<font size="3">Extract the inrate from the passed RBTC value for Bprox minting operation


### <span id="MoCInrate-calcDocRedInterestValues-uint256-uint256-"></span>
 `calcDocRedInterestValues(uint256 docAmount, uint256 rbtcAmount) → uint256` (public)



<font size="3">Extract the inrate from the passed RBTC value for the Doc Redeem operation.


### <span id="MoCInrate-calcFinalRedeemInterestValue-bytes32-uint256-"></span>
 `calcFinalRedeemInterestValue(bytes32 bucket, uint256 rbtcToRedeem) → uint256` (public)
...
### <span id="MoCInrate-calcRedeemInterestValue-bytes32-uint256-"></span>
 `calcRedeemInterestValue(bytes32 bucket, uint256 rbtcToRedeem) → uint256` (public)



<font size="3">Calculates RBTC value to return to the user in concept of interests.


### <span id="MoCInrate-dailyInratePayment--"></span>
 `dailyInratePayment() → uint256` (public)



<font size="3">Moves the daily amount of interest rate to C0 bucket.

### <span id="MoCInrate-isDailyEnabled--"></span>
 `isDailyEnabled() → bool` (public)
...
### <span id="MoCInrate-isBitProInterestEnabled--"></span> 
`isBitProInterestEnabled() → bool` (public)
...
### <span id="MoCInrate-calculateBitProHoldersInterest--"></span>
 `calculateBitProHoldersInterest() → uint256, uint256` (public)



<font size="3">Calculates BitPro Holders interest rates.


### <span id="MoCInrate-payBitProHoldersInterestPayment--"></span>
 `payBitProHoldersInterestPayment() → uint256` (public)



<font size="3">Pays the BitPro Holders interest rates.

### <span id="MoCInrate-initialize-address-address-uint256-uint256-uint256-uint256-uint256-address-payable-address-payable-uint256-uint256-uint256-uint256-"></span>
 `initialize(address connectorAddress, address _governor, uint256 btcxTmin, uint256 btcxPower, uint256 btcxTmax, uint256 _bitProRate, uint256 blockSpanBitPro, address payable bitProInterestTargetAddress, address payable commissionsAddressTarget, uint256 commissionRateParam, uint256 _docTmin, uint256 _docPower, uint256 _docTmax)` (public)
## <span id="MoCLibConnection"></span> `MoCLibConnection`
...
### <span id="MoCLibConnection-getMocPrecision--"></span>
 `getMocPrecision() → uint256` (public)





### <span id="MoCLibConnection-getReservePrecision--"></span>
 `getReservePrecision() → uint256` (public)





### <span id="MoCLibConnection-getDayPrecision--"></span>
 `getDayPrecision() → uint256` (public)


## <span id="MoCWhitelist"></span> `MoCWhitelist`



Provides access control between all MoC Contracts

- [`isWhitelisted(address account)`][MoCWhitelist-isWhitelisted-address-]

### <span id="MoCWhitelist-isWhitelisted-address-"></span>
 `isWhitelisted(address account) → bool` (public)



<font size="3">Check if an account is whitelisted
...
## <span id="MoCConnector"></span> `MoCConnector`



Provides access control between all MoC Contracts.
It is [Initializable](https://github.com/OpenZeppelin/openzeppelin-contracts-ethereum-package), [MoCWhitelist]

- [`initialize(address payable mocAddress, address docAddress, address bproAddress, address bproxAddress, address stateAddress, address settlementAddress, address converterAddress, address exchangeAddress, address inrateAddress, address burnoutBookAddress)`][MoCConnector-initialize-address-payable-address-address-address-address-address-address-address-address-address-]

### <span id="MoCConnector-initialize-address-payable-address-address-address-address-address-address-address-address-address-"></span>
 `initialize(address payable mocAddress, address docAddress, address bproAddress, address bproxAddress, address stateAddress, address settlementAddress, address converterAddress, address exchangeAddress, address inrateAddress, address burnoutBookAddress)` (public)
...
## <span id="Medianizer"></span> `Medianizer`





- [`set(address priceFeed)`][Medianizer-set-address-]


- [`unset(address priceFeed)`][Medianizer-unset-address-]

### <span id="Medianizer-set-address-"></span>
 `set(address priceFeed)` (external)
### <span id="Medianizer-unset-address-"></span> 
`unset(address priceFeed)` (external)
...
## <span id="MoCBProxManagerUpdater"></span> `MoCBProxManagerUpdater`



This contract is used to update the MoCBProxManager to fix the governor variable

- [`constructor(contract AdminUpgradeabilityProxy _proxy, contract UpgradeDelegator _upgradeDelegator, address _newImplementation)`][MoCBProxManagerUpdater-constructor-contract-AdminUpgradeabilityProxy-contract-UpgradeDelegator-address-]

### <span id="MoCBProxManagerUpdater-constructor-contract-AdminUpgradeabilityProxy-contract-UpgradeDelegator-address-"></span>
 `constructor(contract AdminUpgradeabilityProxy _proxy, contract UpgradeDelegator _upgradeDelegator, address _newImplementation)` (public)





## <span id="DSAuth"></span> `DSAuth`





- [`setOwner(address newOwner)`][DSAuth-setOwner-address-]

### <span id="DSAuth-setOwner-address-"></span>
...
## <span id="PriceFactory"></span> `PriceFactory`





- [`create()`][PriceFactory-create--]

### <span id="PriceFactory-create--"></span>
 `create() → contract DSAuth` (external)
...
## <span id="PriceFeederAdder"></span> `PriceFeederAdder`
...
### <span id="PriceFeederAdder-execute--"></span>
 `execute()` (external)
...
## <span id="PriceFeederRemover"></span> `PriceFeederRemover`
...
## <span id="BtcPriceProvider"></span> `BtcPriceProvider`





- [`peek()`][BtcPriceProvider-peek--]

### <span id="BtcPriceProvider-peek--"></span>
...
## <span id="BtcPriceProviderMock"></span> `BtcPriceProviderMock`





- [`constructor(uint256 price)`][BtcPriceProviderMock-constructor-uint256-]
- [`peek()`][BtcPriceProviderMock-peek--]
- [`poke(uint128 val_, uint32)`][BtcPriceProviderMock-poke-uint128-uint32-]
- [`post(uint128 val_, uint32, address)`][BtcPriceProviderMock-post-uint128-uint32-address-]

### <span id="BtcPriceProviderMock-constructor-uint256-"></span>
...
### <span id="BtcPriceProviderMock-peek--"></span>
 `peek() → bytes32, bool` (external)
...
### <span id="BtcPriceProviderMock-poke-uint128-uint32-"></span>
...
### <span id="BtcPriceProviderMock-post-uint128-uint32-address-"></span>
...
- [`spotInrate(uint256 tMin, uint256 tMax, uint256 doc0, uint256 doct)`][MoCHelperLibMock-spotInrate-uint256-uint256-uint256-uint256-]
- [`maxBProWithDiscount(uint256 nB, uint256 nDoc, uint256 utpdu, uint256 peg, uint256 btcPrice, uint256 bproUsdPrice, uint256 spotDiscount)`][MoCHelperLibMock-maxBProWithDiscount-uint256-uint256-uint256-uint256-uint256-uint256-uint256-]
- [`inrateAvg(uint256 tMax, uint256 fact, uint256 tMin, uint256 abRat1, uint256 abRat2)`][MoCHelperLibMock-inrateAvg-uint256-uint256-uint256-uint256-uint256-]
- [`avgInt(uint256 tMax, uint256 fact, uint256 tMin, uint256 abRat1, uint256 abRat2)`][MoCHelperLibMock-avgInt-uint256-uint256-uint256-uint256-uint256-]
- [`potential(uint256 tMax, uint256 fact, uint256 tMin, uint256 abRat)`][MoCHelperLibMock-potential-uint256-uint256-uint256-uint256-]
- [`integral(uint256 tMax, uint256 fact, uint256 tMin, uint256 abRat)`][MoCHelperLibMock-integral-uint256-uint256-uint256-uint256-]
- [`bproSpotDiscountRate(uint256 bproLiqDiscountRate, uint256 liq, uint256 utpdu, uint256 cov)`][MoCHelperLibMock-bproSpotDiscountRate-uint256-uint256-uint256-uint256-]
- [`bucketTransferAmountInfiniteLeverage(uint256 nB, uint256 delta)`][MoCHelperLibMock-bucketTransferAmountInfiniteLeverage-uint256-uint256-]
- [`bucketTransferAmount(uint256 nB, uint256 lev)`][MoCHelperLibMock-bucketTransferAmount-uint256-uint256-]
- [`coverage(uint256 nB, uint256 lB)`][MoCHelperLibMock-coverage-uint256-uint256-]
- [`leverageFromCoverage(uint256 cov)`][MoCHelperLibMock-leverageFromCoverage-uint256-]
- [`leverage(uint256 nB, uint256 lB)`][MoCHelperLibMock-leverage-uint256-uint256-]
- [`maxBProxBtcValue(uint256 nDoc, uint256 peg, uint256 btcPrice, uint256 lev)`][MoCHelperLibMock-maxBProxBtcValue-uint256-uint256-uint256-uint256-]
- [`maxBProxBtcValueInfiniteLeverage(uint256 nDoc, uint256 peg, uint256 btcPrice, uint256 delta)`][MoCHelperLibMock-maxBProxBtcValueInfiniteLeverage-uint256-uint256-uint256-uint256-]

### <span id="MoCHelperLibMock-spotInrate-uint256-uint256-uint256-uint256-"></span>
 `spotInrate(uint256 tMin, uint256 tMax, uint256 doc0, uint256 doct) → uint256` (public)





### <span id="MoCHelperLibMock-maxBProWithDiscount-uint256-uint256-uint256-uint256-uint256-uint256-uint256-"></span> 
`maxBProWithDiscount(uint256 nB, uint256 nDoc, uint256 utpdu, uint256 peg, uint256 btcPrice, uint256 bproUsdPrice, uint256 spotDiscount) → uint256` (public)





### <span id="MoCHelperLibMock-inrateAvg-uint256-uint256-uint256-uint256-uint256-"></span>
 `inrateAvg(uint256 tMax, uint256 fact, uint256 tMin, uint256 abRat1, uint256 abRat2) → uint256` (public)





### <span id="MoCHelperLibMock-avgInt-uint256-uint256-uint256-uint256-uint256-"></span>
 `avgInt(uint256 tMax, uint256 fact, uint256 tMin, uint256 abRat1, uint256 abRat2) → uint256` (public)





### <span id="MoCHelperLibMock-potential-uint256-uint256-uint256-uint256-"></span>
 `potential(uint256 tMax, uint256 fact, uint256 tMin, uint256 abRat) → uint256` (public)





### <span id="MoCHelperLibMock-integral-uint256-uint256-uint256-uint256-"></span>
 `integral(uint256 tMax, uint256 fact, uint256 tMin, uint256 abRat) → uint256` (public)





### <span id="MoCHelperLibMock-bproSpotDiscountRate-uint256-uint256-uint256-uint256-"></span>
 `bproSpotDiscountRate(uint256 bproLiqDiscountRate, uint256 liq, uint256 utpdu, uint256 cov) → uint256` (public)





### <span id="MoCHelperLibMock-bucketTransferAmountInfiniteLeverage-uint256-uint256-"></span> 
`bucketTransferAmountInfiniteLeverage(uint256 nB, uint256 delta) → uint256` (public)





### <span id="MoCHelperLibMock-bucketTransferAmount-uint256-uint256-"></span> 
`bucketTransferAmount(uint256 nB, uint256 lev) → uint256` (public)





### <span id="MoCHelperLibMock-coverage-uint256-uint256-"></span> 
`coverage(uint256 nB, uint256 lB) → uint256` (public)





### <span id="MoCHelperLibMock-leverageFromCoverage-uint256-"></span>
 `leverageFromCoverage(uint256 cov) → uint256` (public)





### <span id="MoCHelperLibMock-leverage-uint256-uint256-"></span>
 `leverage(uint256 nB, uint256 lB) → uint256` (public)





### <span id="MoCHelperLibMock-maxBProxBtcValue-uint256-uint256-uint256-uint256-"></span>
 `maxBProxBtcValue(uint256 nDoc, uint256 peg, uint256 btcPrice, uint256 lev) → uint256` (public)





### <span id="MoCHelperLibMock-maxBProxBtcValueInfiniteLeverage-uint256-uint256-uint256-uint256-"></span>
 `maxBProxBtcValueInfiniteLeverage(uint256 nDoc, uint256 peg, uint256 btcPrice, uint256 delta) → uint256` (public)
...
## <span id="MoCSettlementMock"></span> `MoCSettlementMock`

It is [MoCSettlement]

- [`pubRunDeleveraging()`][MoCSettlementMock-pubRunDeleveraging--]
- [`pubRunRedeemDoc()`][MoCSettlementMock-pubRunRedeemDoc--]
- [`setBlockSpan(uint256 _blockSpan)`][MoCSettlementMock-setBlockSpan-uint256-]

### <span id="MoCSettlementMock-pubRunDeleveraging--"></span>
 `pubRunDeleveraging()` (public)





### <span id="MoCSettlementMock-pubRunRedeemDoc--"></span> 
`pubRunRedeemDoc() → uint256` (public)





### <span id="MoCSettlementMock-setBlockSpan-uint256-"></span>
 `setBlockSpan(uint256 _blockSpan)` (public)



<font size="3">Sets the number of blocks settlement will be allowed to run




## <span id="MoCStateMock"></span> `MoCStateMock`


It is [MoCState]


- [`setDaysToSettlement(uint256 daysToSettl)`][MoCStateMock-setDaysToSettlement-uint256-]
- [`daysToSettlement()`][MoCStateMock-daysToSettlement--]
- [`initialize(address connectorAddress, address _governor, address _btcPriceProvider, uint256 _liq, uint256 _utpdu, uint256 _maxDiscRate, uint256 _dayBlockSpan, uint256 _ema, uint256 _smoothFactor, uint256 _emaBlockSpan, uint256 _maxMintBPro)`][MoCStateMock-initialize-address-address-address-uint256-uint256-uint256-uint256-uint256-uint256-uint256-uint256-]


### <span id="MoCStateMock-setDaysToSettlement-uint256-"></span> 
`setDaysToSettlement(uint256 daysToSettl)` (public)

### <span id="MoCStateMock-daysToSettlement--"></span>
 `daysToSettlement() → uint256` (public)

### <span id="MoCStateMock-initialize-address-address-address-uint256-uint256-uint256-uint256-uint256-uint256-uint256-uint256-"></span>
 `initialize(address connectorAddress, address _governor, address _btcPriceProvider, uint256 _liq, uint256 _utpdu, uint256 _maxDiscRate, uint256 _dayBlockSpan, uint256 _ema, uint256 _smoothFactor, uint256 _emaBlockSpan, uint256 _maxMintBPro)` (public)
...
## <span id="MockGovernor"></span> `MockGovernor`


It is [Governor](https://github.com/money-on-chain/Areopagus-Governance) 



## <span id="MockMakeStoppable"></span> `MockMakeStoppable`




It is [MakeStoppable](https://github.com/money-on-chain/Areopagus-Governance)




## <span id="MockMakeUnstoppable"></span> `MockMakeUnstoppable`


It is [MakeUnstoppable](https://github.com/money-on-chain/Areopagus-Governance)


## <span id="MockStopper"></span> `MockStopper`

It is [Stopper](https://github.com/money-on-chain/Areopagus-Governance)




## <span id="MockUpgradeDelegator"></span> `MockUpgradeDelegator`


It is [UpgradeDelegator](https://github.com/money-on-chain/Areopagus-Governance)



## <span id="MockUpgraderTemplate"></span> `MockUpgraderTemplate`


It is [UpgraderTemplate](https://github.com/money-on-chain/Areopagus-Governance)




## <span id="RevertingOnSend"></span> `RevertingOnSend`
...
- [`fallback()`][RevertingOnSend-fallback--]
- [`setAcceptingMoney(bool accepting)`][RevertingOnSend-setAcceptingMoney-bool-]
- [`mintBProx(bytes32 bucket, uint256 bproxAmountToMint)`][RevertingOnSend-mintBProx-bytes32-uint256-]
- [`mintDoc(uint256 docAmountToMint)`][RevertingOnSend-mintDoc-uint256-]
- [`redeemDoCRequest(uint256 docAmount)`][RevertingOnSend-redeemDoCRequest-uint256-]
- [`constructor(address payable mocAddress)`][RevertingOnSend-constructor-address-payable-]



### <span id="RevertingOnSend-fallback--"></span>
 `fallback()` (external)
...
### <span id="RevertingOnSend-setAcceptingMoney-bool-"></span> 
`setAcceptingMoney(bool accepting)` (public)





### <span id="RevertingOnSend-mintBProx-bytes32-uint256-"></span> 
`mintBProx(bytes32 bucket, uint256 bproxAmountToMint)` (public)





### <span id="RevertingOnSend-mintDoc-uint256-"></span> 
`mintDoc(uint256 docAmountToMint)` (public)





### <span id="RevertingOnSend-redeemDoCRequest-uint256-"></span> 
`redeemDoCRequest(uint256 docAmount)` (public)
