...
const BProxManagerUpgrader = artifacts.require('./contracts/MoCBProxManagerUpdater.sol');
//const BProxManagerFixer = artifacts.require('./contracts/MoCBProxManagerFixer.sol');
...
const createContracts = params => async ({ owner, useMock }) => {
  ...
  const revertingContract = await RevertingOnSend.new(moc.address, { from: owner });
