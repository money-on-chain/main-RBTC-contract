...
contract MoC is MoCEvents, MoCLibConnection, MoCBase, Stoppable  {
  ...
  */
   ...
   */
  function mintBPro(uint256 btcToMint) public payable whenNotPaused() transitionState() notInProtectionMode() {
  ...
  */
  function redeemFreeDoc(uint256 docAmount) public whenNotPaused() transitionState() notInProtectionMode() {
